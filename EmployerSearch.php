                    ...
                    <li class="post">
                        <div class="post-content">
                            <a href="EmployerProfile_Eidt.html">
                                <h4 id="companyName" style="font-weight:bold;"> Sabic Company</h4>
                                ...
                                <span class="icon-side">Riyadh, Saudi Arabia</span>
                                <h4 id="industry">Telecommunications</h4>
                                <h5> About Company:</h5>
                                <p class="descrption">Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti
                                    sint commodi dignissimos aperiam nisi?</p>
                            </a>
                        </div>
                    </li>
